...
sw buf_peek_f32 (s_buf *buf, u32 *p);
sw buf_peek_f64 (s_buf *buf, u64 *p);
...
sw buf_read_f32 (s_buf *buf, u32 *p);
sw buf_read_f64 (s_buf *buf, u64 *p);
sw buf_read_s8 (s_buf *buf, u8 *p);
sw buf_read_s16 (s_buf *buf, u16 *p);
sw buf_read_s32 (s_buf *buf, u32 *p);
sw buf_read_s64 (s_buf *buf, u64 *p);
